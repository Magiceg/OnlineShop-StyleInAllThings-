...
namespace Shop.StyleInAllThings.API.Extensions
{
    public static class DtoConversions
    {
        public static IEnumerable<ProductDto> ConvertToDto(this IEnumerable<Product> producs,
                                                            IEnumerable<ProductCategory> productCategories)
        {
            return (from product  in producs
